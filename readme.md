...
C# ve SQL Veritabaný kullanýlarak geliþtirilen bir uygulamadýr. Bu otomasyon sistemi sayesinde hastane personeli, hasta verilerini kolayca yönetebilir.
Uygulama, hastalarýn kayýtlý olduðu veritabanýný kullanarak aþaðýdaki iþlemleri gerçekleþtirebilir.

# 1- Hasta Verilerini Görüntüleme:
Hasta bilgileri, uygulama arayüzünde tablolar halinde görüntülenebilir. Bu sayede hastalarýn adý, soyadý, T.C. kimlik numarasý, yaþ, cinsiyet,
telefon numarasý gibi bilgilere hýzlýca eriþilebilir.

# 2- Hasta Ekleme
Yeni  bir hasta kaydý oluþturulabilir. Hasta bilgileri kullanýcý tarafýndan girilip veritabanýna eklenir.
